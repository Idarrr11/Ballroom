<footer class="bg-black dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl">
        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold text-white uppercase">Alamat Kami</h2>
                <ul class="text-gray-300 font-medium">
                    <li class="mb-4">
        ...
        <div class="px-4 py-6 bg-gray-800 md:flex md:items-center md:justify-between">
            <span class="text-sm text-gray-300 sm:text-center">Copyright © 2024 Politeknik Nest. All Rights Reserved. Owned by Yayasan Nest Bina Karya</span>
